...
function campaign_default_diplomacy_start_any_game()
	...
	start_yt_faction_progression_listeners();

	disable_non_campaign_diplomatic_treaties();
...
function apply_default_diplomatic_restrictions()
	...
	--Restricting all factions from using faction specific diplomatic treaties
	...
	model:disable_diplomacy("faction:3k_main_faction_yuan_shao", "all", "treaty_components_create_alliance,treaty_components_create_coalition,treaty_components_coalition_to_alliance", "hidden")
	
	--Restricting Yuan Shu from using default alliance, coalition creation treaty or vassalise recipient
	model:disable_diplomacy("faction:3k_main_faction_yuan_shu", "all", "treaty_components_create_alliance,treaty_components_create_coalition,treaty_components_coalition_to_alliance,treaty_components_vassalise_recipient", "hidden")
	
	--Restricting all factions from proposing default vassalise proposer recipient to Yuan Shu
	model:disable_diplomacy("all", "faction:3k_main_faction_yuan_shu", "treaty_components_vassalise_proposer", "hidden")
	
	--Restricting Liu Bei from using default confederation treaty	
	model:disable_diplomacy("faction:3k_main_faction_liu_bei", "all", "treaty_components_confederate_recipient", "hidden")
	
	--Restricting Zeng Jiang from creating vassals
	...
	model:disable_diplomacy("all", "faction:3k_main_faction_rebels", "treaty_components_alliance_democratic,treaty_components_alliance_to_alliance_war,treaty_components_alliance_to_faction_war,treaty_components_ancillary_demand,treaty_components_ancillary_offer,treaty_components_annex_vassal,treaty_components_break_deal_proposer_to_recipient_unilateral,treaty_components_confederate_proposer,treaty_components_confederate_recipient,treaty_components_create_alliance,treaty_components_declare_independence,treaty_components_draw_vassal_into_war,treaty_components_faction_to_alliance_war,treaty_components_food_supply_demand,treaty_components_food_supply_offer,treaty_components_alliance_to_alliance_group_peace,treaty_components_alliance_to_faction_group_peace,treaty_components_faction_to_alliance_group_peace,treaty_components_group_war,treaty_components_guarentee_autonomy,treaty_components_join_alliance_proposers,treaty_components_join_alliance_recipients,treaty_components_join_coalition_proposer,treaty_components_join_coalition_recipient,treaty_components_kick_alliance_member,treaty_components_kick_coalition_member,treaty_components_liberate_proposer,treaty_components_liberate_recipient,treaty_components_marriage_give_female,treaty_components_marriage_give_female_male,treaty_components_marriage_give_male,treaty_components_marriage_give_male_female,treaty_components_marriage_recieve_female,treaty_components_marriage_recieve_female_male,treaty_components_marriage_recieve_male,treaty_components_marriage_recieve_male_female,treaty_components_military_access,treaty_components_non_aggression,treaty_components_payment_demand,treaty_components_payment_offer,treaty_components_payment_regular_demand,treaty_components_payment_regular_offer,treaty_components_peace,treaty_components_proposer_declares_war_against_target,treaty_components_recipient_declares_war_against_target,treaty_components_quit_alliance,treaty_components_quit_coalition,treaty_components_region_demand,treaty_components_region_offer,treaty_components_abdicate_demand,treaty_components_threaten,treaty_components_trade,treaty_components_vassalise_proposer,treaty_components_vassalise_recipient,treaty_components_call_vassals_to_arms,treaty_components_create_coalition,treaty_components_offer_autonomy,treaty_components_demand_autonomy,treaty_components_proposer_declares_war_against_target,treaty_components_recipient_declares_war_against_target,treaty_components_vassal_requests_war,treaty_components_vassal_joins_war,treaty_components_abdicate_demand,treaty_components_abdicate_offer,treaty_components_vassalise_recipient_yellow_turban,treaty_components_vassalise_proposer_yellow_turban,treaty_components_support_independence_offer", "hidden")
	...
	model:enable_diplomacy("faction:3k_main_faction_dong_zhuo", "subculture:3k_main_chinese", "treaty_components_coercion", "hidden")
	model:enable_diplomacy("faction:3k_main_faction_zheng_jiang", "subculture:3k_main_chinese", "treaty_components_tribute_demand", "hidden")
	model:enable_diplomacy("subculture:3k_main_chinese", "faction:3k_main_faction_zheng_jiang", "treaty_components_tribute_offer", "hidden")
	model:enable_diplomacy("faction:3k_main_faction_yuan_shao", "subculture:3k_main_chinese", "treaty_components_create_alliance_yuan_shao,treaty_components_create_coalition_yuan_shao,treaty_components_coalition_to_alliance_yuan_shao", "hidden")
	model:enable_diplomacy("subculture:3k_main_chinese", "faction:3k_main_faction_yuan_shao", "treaty_components_create_alliance_yuan_shao_counter_offer,treaty_components_create_coalition_yuan_shao_counter_offer", "hidden")
	...
	model:enable_diplomacy("subculture:3k_main_chinese", "faction:3k_main_faction_yuan_shu", "treaty_components_create_alliance_yuan_shu_counter_offer,treaty_components_create_coalition_yuan_shu_counter_offer,treaty_components_vassalise_proposer_yuan_shu", "hidden")
	model:enable_diplomacy("faction:3k_main_faction_kong_rong", "subculture:3k_main_chinese", "treaty_components_instigate_trade_monopoly", "hidden")
	model:enable_diplomacy("subculture:3k_main_chinese", "faction:3k_main_faction_kong_rong", "treaty_components_recieve_trade_monopoly", "hidden")
	model:enable_diplomacy("subculture:3k_main_chinese", "faction:3k_main_faction_yuan_shu", "treaty_components_acknowledge_legitimacy_offer", "hidden")
	model:enable_diplomacy("faction:3k_main_faction_liu_bei", "subculture:3k_main_chinese", "treaty_components_liu_bei_confederate_recipient", "hidden")
	model:enable_diplomacy("subculture:3k_main_chinese", "faction:3k_main_faction_liu_bei", "treaty_components_liu_bei_confederate_proposer", "hidden")
	...
	model:disable_diplomacy("faction:3k_main_faction_yuan_shu", "subculture:3k_main_chinese","treaty_components_create_alliance_yuan_shu_counter_offer,treaty_components_create_coalition_yuan_shu_counter_offer", "hidden")
	model:disable_diplomacy("faction:3k_main_faction_yuan_shao", "subculture:3k_main_chinese","treaty_components_create_alliance_yuan_shao_counter_offer,treaty_components_create_coalition_yuan_shao_counter_offer", "hidden")
	model:disable_diplomacy("faction:3k_main_faction_liu_bei", "subculture:3k_main_chinese", "treaty_components_liu_bei_confederate_proposer", "hidden")
...
function start_yt_faction_progression_listeners()
	...
	local progression_level_to_action_mapping = {
		...
		},
		{
			progression_level = 5,
			action = function(faction_key)
				cm:modify_model():enable_diplomacy("faction:"..faction_key, "subculture:3k_main_chinese", "treaty_components_annex_vassal,treaty_components_break_deal_proposer_to_recipient_unilateral,treaty_components_confederate_proposer,treaty_components_confederate_recipient,treaty_components_create_alliance,treaty_components_declare_independence,treaty_components_draw_vassal_into_war,treaty_components_food_supply_demand,treaty_components_food_supply_offer,treaty_components_alliance_to_alliance_group_peace,treaty_components_alliance_to_faction_group_peace,treaty_components_faction_to_alliance_group_peace,treaty_components_group_war,treaty_components_join_alliance_proposers,treaty_components_join_alliance_recipients,treaty_components_join_coalition_proposer,treaty_components_join_coalition_recipient,treaty_components_kick_alliance_member,treaty_components_kick_coalition_member,treaty_components_liberate_proposer,treaty_components_liberate_recipient,treaty_components_military_access,treaty_components_non_aggression,treaty_components_vassalise_recipient_yellow_turban,treaty_components_create_coalition,treaty_components_offer_autonomy,treaty_components_demand_autonomy,treaty_components_vassal_requests_war,treaty_components_vassal_joins_war", "yellow_turban_rank_requirement_proposer")
				cm:modify_model():enable_diplomacy("faction:"..faction_key, "subculture:3k_main_subculture_yellow_turban", "treaty_components_vassalise_recipient", "yellow_turban_rank_requirement_proposer")
				cm:modify_model():disable_diplomacy("faction:"..faction_key, "faction:3k_main_faction_yellow_turban_generic", "treaty_components_vassalise_recipient", "yellow_turban_rank_requirement_proposer")
				cm:modify_model():enable_diplomacy("subculture:3k_main_chinese", "faction:"..faction_key, "treaty_components_annex_vassal,treaty_components_break_deal_proposer_to_recipient_unilateral,treaty_components_confederate_proposer,treaty_components_confederate_recipient,treaty_components_create_alliance,treaty_components_declare_independence,treaty_components_draw_vassal_into_war,treaty_components_food_supply_demand,treaty_components_food_supply_offer,treaty_components_alliance_to_alliance_group_peace,treaty_components_alliance_to_faction_group_peace,treaty_components_faction_to_alliance_group_peace,treaty_components_group_war,treaty_components_join_alliance_proposers,treaty_components_join_alliance_recipients,treaty_components_join_coalition_proposer,treaty_components_join_coalition_recipient,treaty_components_kick_alliance_member,treaty_components_kick_coalition_member,treaty_components_liberate_proposer,treaty_components_liberate_recipient,treaty_components_military_access,treaty_components_non_aggression,treaty_components_vassalise_proposer_yellow_turban,treaty_components_create_coalition,treaty_components_offer_autonomy,treaty_components_demand_autonomy,treaty_components_vassal_requests_war,treaty_components_vassal_joins_war", "yellow_turban_rank_requirement_recipient")
				cm:modify_model():enable_diplomacy("subculture:3k_main_subculture_yellow_turban", "faction:"..faction_key, "treaty_components_vassalise_proposer", "yellow_turban_rank_requirement_recipient")
				cm:modify_model():disable_diplomacy("faction:3k_main_faction_yellow_turban_generic", "faction:"..faction_key, "treaty_components_vassalise_proposer", "yellow_turban_rank_requirement_recipient")
			end
		}
	};
	...
	for i = 1, #eligible_faction_list do
		...
		local current_faction_progression_level_key = current_faction_key .. "_yt_progression_applied";
					...
					for j = 1, #progression_level_to_action_mapping do
						...
						if current_mapping.progression_level > cm:get_saved_value(current_faction_progression_level_key) and current_mapping.progression_level <= new_progression_level_of_faction then
							...
							if j == #progression_level_to_action_mapping then
								...
								core:remove_listener(current_faction_key .. "_yt_progression");
							end;
...
function disable_non_campaign_diplomatic_treaties()
		local model = cm:modify_model();
		
		-- Disabling all diplomatic actions that should never appear in this campaign
		model:disable_diplomacy("all", "all", "treaty_components_attitude_manipulation_positive_sima_yue,treaty_components_attitude_manipulation_negative_sima_yue,treaty_components_sima_lun_instigate_proxy_war_proposer,treaty_components_sima_lun_coercion,treaty_components_sima_lun_recieve_coercion,treaty_components_vassalise_proposer_sima_liang,treaty_components_vassalise_recipient_sima_liang", "hidden")
end
