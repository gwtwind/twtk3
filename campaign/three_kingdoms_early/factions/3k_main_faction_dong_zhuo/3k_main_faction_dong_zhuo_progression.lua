-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
------------------------ Dong Zhuo Progression Missions -------------------------
-------------------------------------------------------------------------------
...
core:add_listener(
    ...
    true,
    function()
        core:trigger_event("ScriptEventDongZhuoProgressionMission01Trigger")
    end,
    false
)
...
start_progression_mission_listener(
    ...
    "ScriptEventDongZhuoProgressionMission01Trigger",      -- trigger event 
...
start_progression_mission_listener(
    ...
    "ScriptEventDongZhuoProgressionMission03Complete"
)