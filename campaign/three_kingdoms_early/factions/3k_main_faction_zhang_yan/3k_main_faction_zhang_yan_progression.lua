-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
------------------------ zhang yan Progression Missions -------------------------
-------------------------------------------------------------------------------
...
core:add_listener(
    ...
    true,
    function()
        core:trigger_event("ScriptEventZhangYanProgressionMission01Trigger")
    end,
    false
)

-- zhang yan progression mission 1
start_progression_mission_listener(
    "3k_main_faction_zhang_yan",                          -- faction key
    "3k_main_victory_objective_chain_1_zhang_yan",                     -- mission key
    ...
    "ScriptEventZhangYanProgressionMission01Trigger",      -- trigger event 
    "ScriptEventZhangYanProgressionMission01Complete"     -- completion event
)

-- zhang yan progression mission 02
start_progression_mission_listener(
    "3k_main_faction_zhang_yan",                          -- faction key
    ...
    "ScriptEventZhangYanProgressionMission01Complete",      -- trigger event 
    "ScriptEventZhangYanProgressionMission02Complete"      -- completion event
)

-- zhang yan progression mission 03
start_progression_mission_listener(
    "3k_main_faction_zhang_yan",                          -- faction key
    ...
    "ScriptEventZhangYanProgressionMission02Complete",      -- trigger event 
    "ScriptEventZhangYanProgressionMission03Complete"     -- completion event
)

-- zhang yan progression mission 04
start_progression_mission_listener(
    "3k_main_faction_zhang_yan",                          -- faction key
    ...
    "ScriptEventZhangYanProgressionMission03Complete",      -- trigger event 
    ""
)