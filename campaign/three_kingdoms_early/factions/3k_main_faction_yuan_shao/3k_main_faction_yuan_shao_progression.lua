-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
------------------------ yuan shao Progression Missions -------------------------
-------------------------------------------------------------------------------
...
core:add_listener(
    ...
    true,
    function()
        core:trigger_event("ScriptEventYuanShaoProgressionMission01Trigger")
    end,
    false
)

-- yuan shao progression mission 1
start_progression_mission_listener(
    "3k_main_faction_yuan_shao",                          -- faction key
    "3k_main_victory_objective_chain_1_yuan_shao",                     -- mission key
    ...
    "ScriptEventYuanShaoProgressionMission01Trigger",      -- trigger event 
    "ScriptEventYuanShaoProgressionMission01Complete"     -- completion event
)

-- yuan shao progression mission 02
start_progression_mission_listener(
    "3k_main_faction_yuan_shao",                          -- faction key
    ...
    "ScriptEventYuanShaoProgressionMission01Complete",      -- trigger event 
    "ScriptEventYuanShaoProgressionMission02Complete"      -- completion event
)

-- yuan shao progression mission 03
start_progression_mission_listener(
    "3k_main_faction_yuan_shao",                          -- faction key
    ...
    "ScriptEventYuanShaoProgressionMission02Complete",      -- trigger event 
    "ScriptEventYuanShaoProgressionMission03Complete"     -- completion event
)

-- yuan shao progression mission 04
start_progression_mission_listener(
    "3k_main_faction_yuan_shao",                          -- faction key
    ...
    "ScriptEventYuanShaoProgressionMission03Complete",      -- trigger event 
    ""
)