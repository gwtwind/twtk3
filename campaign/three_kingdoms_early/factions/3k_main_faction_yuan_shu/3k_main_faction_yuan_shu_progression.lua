...
core:add_listener(
    ...
    true,
    function()
        core:trigger_event("ScriptEventYuanShuProgressionMission01Trigger")
    end,
    false
)

-- yuan shu progression mission 1
start_progression_mission_listener(
    "3k_main_faction_yuan_shu",                          -- faction key
    "3k_main_victory_objective_chain_1_yuan_shu",                     -- mission key
    ...
    "ScriptEventYuanShuProgressionMission01Trigger",      -- trigger event 
    "ScriptEventYuanShuProgressionMission01Complete"     -- completion event
)

-- yuan shu progression mission 02
start_progression_mission_listener(
    "3k_main_faction_yuan_shu",                          -- faction key
    ...
    "ScriptEventYuanShuProgressionMission01Complete",      -- trigger event 
    "ScriptEventYuanShuProgressionMission02Complete"      -- completion event
)

-- yuan shu progression mission 03
start_progression_mission_listener(
    "3k_main_faction_yuan_shu",                          -- faction key
    ...
    "ScriptEventYuanShuProgressionMission02Complete",      -- trigger event 
    "ScriptEventYuanShuProgressionMission03Complete"     -- completion event
)

-- yuan shu progression mission 04
start_progression_mission_listener(
    "3k_main_faction_yuan_shu",                          -- faction key
    ...
    "ScriptEventYuanShuProgressionMission03Complete",      -- trigger event 
    ""
)