-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
------------------------ yellow turban taishan Progression Missions -------------------------
-------------------------------------------------------------------------------
...
-- yellow turban taishan progression mission 1
start_progression_mission_listener(
    "3k_main_faction_yellow_turban_taishan",                          -- faction key
    "3k_main_victory_objective_chain_1_huang_shao",                     -- mission key
    ...
    "ScriptEventYellowTurbanTaishanProgressionMission01Trigger",      -- trigger event 
    "ScriptEventYellowTurbanTaishanProgressionMission01Complete"     -- completion event
)

-- yellow turban taishan progression mission 02
start_progression_mission_listener(
    "3k_main_faction_yellow_turban_taishan",                          -- faction key
    ...
    "ScriptEventYellowTurbanTaishanProgressionMission01Complete",      -- trigger event 
    "ScriptEventYellowTurbanTaishanProgressionMission02Complete"      -- completion event
)

-- yellow turban taishan progression mission 03
start_progression_mission_listener(
    "3k_main_faction_yellow_turban_taishan",                          -- faction key
    ...
    "ScriptEventYellowTurbanTaishanProgressionMission02Complete",      -- trigger event 
    "ScriptEventYellowTurbanTaishanProgressionMission03Complete"     -- completion event
)

-- yellow turban taishan progression mission 04
start_progression_mission_listener(
    "3k_main_faction_yellow_turban_taishan",                          -- faction key
    ...
    "ScriptEventYellowTurbanTaishanProgressionMission03Complete",      -- trigger event 
    ""
)
...
core:add_listener(
    ...
    true,
    function()
        core:trigger_event("ScriptEventYellowTurbanTaishanProgressionMission01Trigger")
    end,
    false
)
