-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
------------------------ gongsun zan Progression Missions ---------------------
-------------------------------------------------------------------------------
...
core:add_listener(
    ...
    true,
    function()
        core:trigger_event("ScriptEventGongsunZanProgressionMission01Trigger")
    end,
    false
)

-- gongsun zan progression mission 1
start_progression_mission_listener(
    "3k_main_faction_gongsun_zan",                          -- faction key
    "3k_main_victory_objective_chain_1_gongsun_zan",                     -- mission key
    ...
    "ScriptEventGongsunZanProgressionMission01Trigger",      -- trigger event 
    "ScriptEventGongsunZanProgressionMission01Complete"     -- completion event
)

-- gongsun zan progression mission 02
start_progression_mission_listener(
    "3k_main_faction_gongsun_zan",                          -- faction key
    ...
    "ScriptEventGongsunZanProgressionMission01Complete",      -- trigger event 
    "ScriptEventGongsunZanProgressionMission02Complete"      -- completion event
)

-- gongsun zan progression mission 03
start_progression_mission_listener(
    "3k_main_faction_gongsun_zan",                          -- faction key
    ...
    "ScriptEventGongsunZanProgressionMission02Complete",      -- trigger event 
    "ScriptEventGongsunZanProgressionMission03Complete"     -- completion event
)

-- gongsun zan progression mission 04
start_progression_mission_listener(
    "3k_main_faction_gongsun_zan",                          -- faction key
    ...
    "ScriptEventGongsunZanProgressionMission03Complete",      -- trigger event 
    "ScriptEventGongsunZanProgressionMissionsCompleted"
)