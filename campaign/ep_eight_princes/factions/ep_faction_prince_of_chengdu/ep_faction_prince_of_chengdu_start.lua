...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/ep_eight_princes/factions/campaign_intro_cutscenes/scenes/scene_01_sima_ying.CindyScene", 0, 10);
		end,
		0
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_01", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_01_advisor");
		end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_02", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_02_sima_ying");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_03", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_03_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_04", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_04_sima_ying");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_05", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_05_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_06", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_06_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_07", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_07_sima_ying");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ying_08", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ying_08_advisor");
		end	
	);
...
---------------------------------------------------------------
--	Turn One Region Visibility: Sima Ying
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("ep_faction_prince_of_chengdu");
...
---------------------------------------------------------------
--	Turn One Map Pins: Sima Ying -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("ep_faction_prince_of_chengdu_start.lua: Adding turn one character map pins for Sima Ai's faction.");
	...
	local sima_di = cm:query_faction("ep_faction_prince_of_han"):faction_leader():cqi();
	local sima_ying = cm:query_faction("ep_faction_prince_of_chengdu"):faction_leader():cqi();

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["ep_startpos_pin_sima_ying_sima_wei"] = sima_wei,
			["ep_startpos_pin_sima_ying_sima_di"] = sima_di,
      ["ep_startpos_pin_sima_ying_sima_ying"] = sima_ying
		}
...
function add_turn_one_settlement_map_pins()
	output("ep_faction_prince_of_chengdu.lua: Adding turn one settlement map pins for Sima Ai's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["ep_startpos_pin_sima_ying_jin_empire"] = "3k_main_luoyang_capital",
		}
...
function end_turn_map_pin_removal_listener()
	output("ep_faction_prince_of_chengdu_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("ep_faction_prince_of_chengdu_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("ep_faction_prince_of_chengdustart.lua: Removing guide map pins.");
