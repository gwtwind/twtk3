...
output("cutscene_intro_play");
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/ep_eight_princes/factions/campaign_intro_cutscenes/scenes/scene_01_sima_liang.CindyScene", 0, 10);
		end,
		0
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_01", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_01_advisor");
		end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_02", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_02_sima_liang");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_03", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_03_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_04", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_04_sima_liang");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_05", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_05_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_06", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_06_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_08", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_08_sima_liang");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_liang_09", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_liang_09_advisor");
		end	
	);
...
---------------------------------------------------------------
--	Turn One Region Visibility: Sima Liang
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("ep_faction_prince_of_runan");
...
---------------------------------------------------------------
--	Turn One Map Pins: Sima Liang -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("ep_faction_prince_of_runan_start.lua: Adding turn one character map pins for Sima Liang's faction.");

	-- Find pinned faction leader character cqis from their faction records
	local cao_huan = cm:query_faction("ep_faction_prince_of_chenliu"):faction_leader():cqi();
	local sima_wei= cm:query_faction("ep_faction_prince_of_chu"):faction_leader():cqi();
  local sima_mao= cm:query_faction("ep_faction_prince_of_jiangling"):faction_leader():cqi();
  local sima_liang= cm:query_faction("ep_faction_prince_of_runan"):faction_leader():cqi();
	...
	local map_pin_characters = 
		{
			["ep_startpos_pin_sima_liang_cao_huan"] = cao_huan,
			["ep_startpos_pin_sima_liang_sima_wei"] = sima_wei,
      ["ep_startpos_pin_sima_liang_sima_mao"] = sima_mao,
      ["ep_startpos_pin_sima_liang_sima_liang"] = sima_liang
    }
...
function add_turn_one_settlement_map_pins()
	output("ep_faction_prince_of_runan.lua: Adding turn one settlement map pins for Sima Liang's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["ep_startpos_pin_sima_liang_jin_empire"] = "3k_main_luoyang_capital",
		}
...
function end_turn_map_pin_removal_listener()
	output("ep_faction_prince_of_runan_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("ep_faction_prince_of_runan_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("ep_faction_prince_of_runan_start.lua: Removing guide map pins.");
