...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/ep_eight_princes/factions/campaign_intro_cutscenes/scenes/scene_01_sima_ai.CindyScene", 0, 10);
		end,
		0
	);	
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_01", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_01_advisor");
		end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_02", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_02_sima_ai");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_03", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_04_sima_ai");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_04", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_03_advisor");
		end	
	);	
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_05", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_05_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_06", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_06_sima_ai");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_ai_07", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_ai_07_advisor");
		end	
	);
...
---------------------------------------------------------------
--	Turn One Region Visibility: Sima Ai
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("ep_faction_prince_of_changsha");
  ...
  modify_faction:make_region_seen_in_shroud("3k_main_yuzhang_resource_1");
  modify_faction:make_region_seen_in_shroud("3k_main_yuzhang_capital")
end



---------------------------------------------------------------
--	Turn One Map Pins: Sima Ai -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("ep_faction_prince_of_changsha_start.lua: Adding turn one character map pins for Sima Ai's faction.");

	-- Find pinned faction leader character cqis from their faction records
	local prince_of_lingling = cm:query_faction("ep_faction_prince_of_lingling"):faction_leader():cqi();
	local sima_liang = cm:query_faction("ep_faction_prince_of_runan"):faction_leader():cqi();
	local sima_ai = cm:query_faction("ep_faction_prince_of_changsha"):faction_leader():cqi();

	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["ep_startpos_pin_sima_ai_prince_of_lingling"] = prince_of_lingling,
			["ep_startpos_pin_sima_ai_sima_liang"] = sima_liang,
      ["ep_startpos_pin_sima_ai_sima_ai"] = sima_ai
...
function add_turn_one_settlement_map_pins()
	output("ep_faction_prince_of_changsha.lua: Adding turn one settlement map pins for Sima Ai's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["ep_startpos_pin_sima_ai_jin_empire"] = "3k_main_luoyang_capital",
		}
...
function end_turn_map_pin_removal_listener()
	output("ep_faction_prince_of_changsha_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("ep_faction_prince_of_changsha_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("ep_faction_prince_of_changsha.lua: Removing guide map pins.");
