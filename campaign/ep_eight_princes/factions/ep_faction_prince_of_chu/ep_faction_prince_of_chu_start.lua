...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/ep_eight_princes/factions/campaign_intro_cutscenes/scenes/scene_01_sima_wei.CindyScene", 0, 10);
		end,
		0
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_01", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_01_advisor");
		end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_02", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_02_sima_wei");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_03", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_03_sima_wei");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_04", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_04_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_05", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_05_sima_wei");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_06", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_06_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_07", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_07_sima_wei");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_wei_08", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_wei_08_advisor");
		end	
	);
...
---------------------------------------------------------------
--	Turn One Region Visibility: Sima Wei
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("ep_faction_prince_of_chu");
...
---------------------------------------------------------------
--	Turn One Map Pins: Sima Wei -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("ep_faction_prince_of_chu_start.lua: Adding turn one character map pins for Sima Ai's faction.");
  ...
  local wei_guan = cm:query_faction("ep_faction_duke_of_lanling"):faction_leader():cqi();
   
	-- Create a table connecting our map_pin records with our derived character CQIs
	local map_pin_characters = 
		{
			["ep_startpos_pin_sima_wei_sima_liang"] = sima_liang,
			["ep_startpos_pin_sima_wei_sima_lun"] = sima_lun,
      ["ep_startpos_pin_sima_wei_sima_wei"] = sima_wei,
      ["ep_startpos_pin_sima_wei_wei_guan"] = wei_guan
		}
...
function add_turn_one_settlement_map_pins()
	output("ep_faction_prince_of_chu.lua: Adding turn one settlement map pins for Sima Wei's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["ep_startpos_pin_sima_wei_jin_empire"] = "3k_main_luoyang_capital"
		}
...
function end_turn_map_pin_removal_listener()
	output("ep_faction_prince_of_chu_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("ep_faction_prince_of_chu_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("ep_faction_prince_of_chu_start.lua: Removing guide map pins.");
