...
function cutscene_intro_play()
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/ep_eight_princes/factions/campaign_intro_cutscenes/scenes/scene_01_sima_yong.CindyScene", 0, 10);
		end,
		0
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_01", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_01_advisor");
		end
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_02", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_02_sima_yong");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_03", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_03_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_04", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_04_sima_yong");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_05", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_05_advisor");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_06", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_06_sima_yong");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_07", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_07_sima_yong");
		end	
	);
	...
	cutscene_intro:add_cinematic_trigger_listener(
		"line_yong_08", 
		function()
			cm:show_advice("ep_campaign_faction_intro_sima_yong_08_advisor");
		end	
	);
...
---------------------------------------------------------------
--	Turn One Region Visibility: Sima Yong
---------------------------------------------------------------
...
function turn_one_region_visibility()
	...
	local modify_faction = cm:modify_faction("ep_faction_prince_of_hejian");
  ...
  modify_faction:make_region_seen_in_shroud("3k_main_beihai_capital");
end



---------------------------------------------------------------
--	Turn One Map Pins: Sima Yong -- [DS]
---------------------------------------------------------------

function add_turn_one_character_map_pins()
	output("ep_faction_prince_of_hejian_start.lua: Adding turn one character map pins for Sima Yong's faction.");

	-- Find pinned faction leader character cqis from their faction records
	local sima_gan = cm:query_faction("ep_faction_prince_of_pingyuan"):faction_leader():cqi();
  ...
  local sima_yong= cm:query_faction("ep_faction_prince_of_hejian"):faction_leader():cqi();
	...
	local map_pin_characters = 
		{
			["ep_startpos_pin_sima_yong_sima_gan"] = sima_gan,
			["ep_startpos_pin_sima_yong_sima_jiong"] = sima_jiong,
      ["ep_startpos_pin_sima_yong_sima_yong"] = sima_yong
    }
...
function add_turn_one_settlement_map_pins()
	output("ep_faction_prince_of_hejian.lua: Adding turn one settlement map pins for Sima Yong's faction.");

	-- Create a table connecting our map_pin records with our region records /settlements
	local map_pin_settlements = 
		{
			["ep_startpos_pin_sima_yong_jin_empire"] = "3k_main_luoyang_capital",
		}
...
function end_turn_map_pin_removal_listener()
	output("ep_faction_prince_of_hejian_start.lua: Adding End Turn Map Pin Removal Listener.");
	...
	core:add_listener(
		...
		function(context)
			output("ep_faction_prince_of_hejian_start.lua: Turn one has ended.");
			return context:query_model():turn_number() == 1;
		end,

		-- Remove the scripted pins.
		function(context)
			output("ep_faction_prince_of_hejian_start.lua: Removing guide map pins.");
