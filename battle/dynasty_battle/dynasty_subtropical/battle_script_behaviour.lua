...
local intro_cinematic_file =  "script\\battle\\dynasty_battle\\_cutscene\\managers\\subtropical_dynasty.CindySceneManager";
...
function play_intro_cutscene()
	...
	local intro_cutscene = cutscene:new(
		"dynasty_mode_temperate_01", 			-- unique string name for cutscene
